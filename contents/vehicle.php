			...
			<div class="col-10 " style="height: 100vh;">
				...
				<div class="d-flex justify-content-between">
					<div class="card p-4" style="width: 18rem;">
						<h6>VEHICLES</h6>
						<a href="#"><button class="mt-4" style="height: 6vh; background-color:#575757; width: 100%; color: white; border: none;">A Vehicles</button></a>
					...
					<div class="card p-4" style="width: 68rem;">
						...
						<div class="d-flex justify-content-around">
							<a href="vehicledisplay.php" ><button style="height: 6vh; background-color: #FB7A72; width: 100%; color: white; border: none;">STERY APC</button></a>
							<button style="height: 6vh; background-color: #FB7A72; width: 15%; color: white; border: none;">STERY APC</button>
							<button style="height: 6vh; background-color: #FB7A72; width: 15%; color: white; border: none;">STERY APC</button>
							<button style="height: 6vh; background-color: #FB7A72; width: 15%; color: white; border: none;">STERY APC</button>
							<button style="height: 6vh; background-color: #FB7A72; width: 15%; color: white; border: none;">STERY APC</button>
							<button style="height: 6vh; background-color: #FB7A72; width: 15%; color: white; border: none;">STERY APC</button>
