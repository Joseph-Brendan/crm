			...
			<div class="col-10 " style="height: 100vh;">
				...
				<div class="d-flex justify-content-between">
					...
					<div class="card p-4" style="width: 18rem;">
						...
						<button class="mt-4" style="height: 6vh; background-color: #858484; color: white; border: none;">Artillery</button>
						<button class="mt-4" style="height: 6vh; background-color: #858484; color: white; border: none;">Radio Equipments</button>
						<button class="mt-4" style="height: 6vh; background-color: #858484; color: white; border: none;">Misc Equipments</button>
						<button class="mt-4" style="height: 6vh; background-color: #858484; color: white; border: none;">Inf Equipments</button>
						<button class="mt-4" style="height: 6vh; background-color: #858484; color: white; border: none;">Tech Equipments</button>
						<button class="mt-4" style="height: 6vh; background-color: #858484; color: white; border: none;">Engineering Equipments</button>
					</div>
					...
					<div class="card" style="width: 18rem;">
						<a href="#" style="margin-top: 200px; margin-left: 48px;"><button>+ ADD NEW INVENTORY</button></a>
					</div>
				</div>
