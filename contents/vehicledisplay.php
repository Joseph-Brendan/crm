            ...
            <div class="col-10 " style="height: 100vh;">
                <div class="mt-5 mb-5">
                    ...
                    <div class="btn-group dropright">
                        <a href="./entryForm.php">
                            <button type="button" class="btn btn-secondary dropdown-toggle ml-5" data-toggle=""
                ...
                <div class="d-flex justify-content-between">
                    <div class="card p-4" style="width: 18rem;">
                        ...
                        <a href="./history.php">
                            <button class="mt-4"
                                    style="border:none; height: 6vh; background-color: #575757; color: white;width: 100%;">
                                REPAIR HISTORY
                            </button>
                        </a>
                        <a href="./update.php">
                    ...
                    <div class="card p-4" style="width: 68rem;">
                        ...
                        <img src="./images/images 1.svg" height="400" alt="">
